...
import com.shifenkafei.sflc.business.dao.OrderDao;
import com.shifenkafei.sflc.business.dao.SuggestDao;
import com.shifenkafei.sflc.business.po.Order;
import com.shifenkafei.sflc.business.service.OrderService;
import com.shifenkafei.sflc.util.MD5;
import com.shifenkafei.sflc.util.ReturnMap;
import com.shifenkafei.sflc.wechat.po.OAuth2AccessToken;
import com.shifenkafei.sflc.wechat.util.*;
...
import static com.shifenkafei.sflc.util.LogUtil.PAYMENTLOG;

@SuppressWarnings({"unchecked", "unused"})
@Service
public class PayServiceImpl {

    protected static Logger logger = PAYMENTLOG;
    ...
    public Map<String, Object> uniformOrder(String orderNo, String openid, HttpServletRequest req) throws JDOMException, IOException {
        ...
        Double orderTotalPrice = orderService.getOrderTotalPrice(orderNo);
        ...
        if ("SUCCESS".equals(return_code)) {
            Map<String, Object> map = ReturnMap.success();
            ...
            String sign = MD5.GetMD5Code(signs.toString());
